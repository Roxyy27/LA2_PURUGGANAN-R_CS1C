...
console.log("d >= e:", d >= e);
console.log("d <= e:", d <= e);
console.log("d === e:", d === e); // Note: This will be false because d is a string and e is a number
...
let subtractionResult = a - b - c - parseInt(d); //parseInt is needed here too
...
// 4. Reassign the value of c (12) to constant e.  This is not possible because 'e' is a constant.
//let newE = c; //This line will cause an error because e is a constant.  Constants cannot be reassigned.
console.log("It's not possible to reassign the value of c to e because e is a constant.");
